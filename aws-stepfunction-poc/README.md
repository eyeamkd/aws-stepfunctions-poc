...
```bash
aws-stepfunction-poc$ sam build
```
...
```bash
aws-stepfunction-poc$ sam logs -n StockCheckerFunction --stack-name aws-stepfunction-poc --tail
```
...
```bash
aws-stepfunction-poc$ dotnet test tests/StockChecker.Test
```
...
```bash
sam delete --stack-name aws-stepfunction-poc
```
